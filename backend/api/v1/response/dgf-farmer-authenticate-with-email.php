...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($data->email) && !empty($data->password)) {
        ...
        $authToken = $response->checkIfFarmerCredentialsIsValid($data->email, $data->password);
        ...
        if ($authToken) {
            ...
            echo json_encode(array("status" => true, "message" => "Login successful.", "token" => $authToken, "farmerData" => $farmerData));
        } else {
