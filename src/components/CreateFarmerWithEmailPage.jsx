...
export default function CreateFarmerWithEmailPage({ isMobile }) {
  ...
  const currentPageName = "Register Farmer";
    ...
    try {
      ...
      const response = await axiosInstance.post(
        (import.meta.env.VITE_IS_LIVE === "true"
          ? import.meta.env.VITE_API_SERVER_URL
          : import.meta.env.VITE_API_DEMO_SERVER_URL) +
          import.meta.env.VITE_FARMER_REGISTER_WITH_EMAIL,
        requestData,
        {
          headers: {
      ...
      if (response.data.status) {
        ...
        setCookie(
          "dgf-farmer-details",
          JSON.stringify(response.data.farmerData)
        );
                      ...
                      >
                        <div className="w-full">
                          <h2 className="text-xl text-black font-bold">
                            ...
                            <span className="text-theme">DiGiFaMar</span> Farmer Profile:
                          </h2>
