...
import { setCookie, isUserAuthenticated } from "../../auth/authUtils"; // Ensure the correct relative path
...
//delete this when done testing
    ...
    try {
      ...
      if (response.data.status) {
        ...
        setCookie("dgf-user-details", JSON.stringify(response.data.userData));
        //  refreshMemberDetails();
        //  navigateTo('/');
                    ...
                    <div className="hidden md:flex flex-col justify-center items-center h-screen">
                      <div className="relative w-full max-w-md mx-auto rounded-2xl overflow-hidden">
                        <h2 className="text-4xl text-black font-bold text-center mt-12 mb-4">
                          Verify your{" "}
                          <span className="text-theme">DiGiFaMaR</span>{" "} User
                          Membership!
                        </h2>
                        <img 
                        // src={africa} 
