...
import styles from "./UserMobileNavbar.module.css";
import { NavLink } from "react-router-dom";
import { navData } from "./UserNavData";
  ...
  return (
    <div className="bg-white shadow-lg px-4" style={{ height: "80px" }}>
      <div className="flex justify-between items-center relative h-[80px]">
        ...
        <div
          className="absolute top-0  flex items-center bg-white p-2  rounded-full z-[100] cursor-pointer"
          onClick={() => {
            navigate("/");
          }}
        >
        ...
        <div className="absolute top-6 right-0 flex gap-2">
          {/* < LoampButton /> */}
          {/* <div
            className="cursor-pointer hover:text-theme hover:bg-black bg-theme border-1 border-white rounded-md px-2 py-2 mr-2"
            onClick={() => {
              navigate(-1);
            }}
          >
        ...
        <MenuContent className="">
          <div className="">
            <div className="flex justify-between items-center pl-4 pr-8  bg-gradient-to-r from-white to-white shadow-lg h-[80px]">
              <div className=" mt-0 flex items-center bg-white p-2 rounded-full">
                <img
                  className="block h-16 w-auto max-w-none"
                  src={logo}
                  alt="Logo"
            ...
            <div className="mt-8 pb-2 mx-6">
              ...
              <motion.span
                ...
                className="text-md text-black cursor-pointer block py-3 px-8 hover:bg-theme hover:text-white rounded-lg"
                onClick={() => {
                  gotoPage("user-verification-status");
                }}
              >
                Verification Status
              </motion.span> */}
